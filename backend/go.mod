...
require (
	...
	github.com/cloudwego/eino-examples v0.0.0-20260312075635-6a9fa80f5a6c
	...
	github.com/cloudwego/eino-ext/components/tool/duckduckgo/v2 v2.0.0-20260313050455-88e279b3b32f
